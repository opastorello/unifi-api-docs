# UniFi Network API - v10.0.162 - Referência

> Espelho automático de [`developer.ui.com/network/v10.0.162`](https://developer.ui.com/network/v10.0.162).
> OpenAPI `3.1.0` · 50 operações em 32 paths · atualizado na origem em `2026-08-22T21:50:52.083Z`.
...
| Supporting Resources | `GET` | `/v1/dpi/categories` | List DPI Categories |
...
- `vlanId` **(obrigatório)**: `integer` (int32)
...
|---|---|---|---|---|
| `networkId` | path | sim | string (uuid) |  |
| `cascade` | query | não | boolean | (default False) |
...
- `networkIds` **(obrigatório)**: `array` - List of Network IDs
  - _array de_ `obj`:
    - ex: `dfb21062-8ea0-4dca-b1d8-1eb3da00e58b`
...
Delete an existing user defined ACL rule
...
`GET /v1/dpi/categories`  ·  operationId: `getCategories`
...
`GET /v1/dpi/applications`  ·  operationId: `getApplications`
