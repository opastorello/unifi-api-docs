...
> OpenAPI `3.1.0` · 73 operações em 44 paths · atualizado na origem em `2026-06-25T08:38:50.888Z`.

**OpenAPI completo (fonte da verdade):** [`openapi.json`](./openapi.json)

## Getting Started

Provides an overview of the UniFi Network API, including authentication using API keys and request format. 
    ...
    - `lags` **(obrigatório)**: `array`
      - _array de_ `object`:
        ...
        - `metadata` **(obrigatório)**
          - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `SYSTEM_DEFINED`→`System defined entity metadata`, `DERIVED`→`Derived entity metadata`, `ORCHESTRATED`→`Orchestrated entity metadata` (ver openapi.json)_
          - `origin` **(obrigatório)**: `string`
          - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `SYSTEM_DEFINED`→`System defined entity metadata` (ver openapi.json)_
          - `origin` **(obrigatório)**: `string`
          - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `DERIVED`→`Derived entity metadata` (ver openapi.json)_
          - `origin` **(obrigatório)**: `string`
          - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `SYSTEM_DEFINED`→`System defined entity metadata`, `ORCHESTRATED`→`Orchestrated entity metadata` (ver openapi.json)_
          - `origin` **(obrigatório)**: `string`
          - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `ORCHESTRATED`→`Orchestrated entity metadata` (ver openapi.json)_
          - `origin` **(obrigatório)**: `string`
          - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `DERIVED`→`Derived entity metadata`, `ORCHESTRATED`→`Orchestrated entity metadata` (ver openapi.json)_
          - `origin` **(obrigatório)**: `string`
          - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `DERIVED`→`IntegrationDerivedSiteToSiteTunnelMetadata` (ver openapi.json)_
          - `origin` **(obrigatório)**: `string`
  - `accessPoint`
...
- _variantes por `management`: `UNMANAGED`→`Unmanaged network details`, `GATEWAY`→`Gateway managed network details`, `SWITCH`→`Switch managed network details` (ver openapi.json)_
...
- _variantes por `management`: `UNMANAGED`→`IntegrationUnmanagedNetworkCreateUpdateDto`, `GATEWAY`→`IntegrationGatewayManagedNetworkCreateUpdateDto`, `SWITCH`→`IntegrationSwitchManagedNetworkCreateUpdateDto` (ver openapi.json)_
- `management` **(obrigatório)**: `string`
- `name` **(obrigatório)**: `string` ex: `Default Network`
- `enabled` **(obrigatório)**: `boolean`
- `vlanId` **(obrigatório)**: `integer` (int32) - VLAN ID. Must be 1 for the default network and >= 2 for additional networks.
...
- `data` **(obrigatório)**: `array`
  - _array de_ `object`:
    - _variantes por `management`: `UNMANAGED`→`Unmanaged network overview`, `GATEWAY`→`Gateway managed network overview`, `SWITCH`→`Switch managed network overview` (ver openapi.json)_
    - `management` **(obrigatório)**: `string`
    - `id` **(obrigatório)**: `string` (uuid)
    - `name` **(obrigatório)**: `string` ex: `Default Network`
    - `enabled` **(obrigatório)**: `boolean`
...
- _variantes por `type`: `STANDARD`→`IntegrationStandardWifiBroadcastDetailDto`, `IOT_OPTIMIZED`→`IntegrationIotOptimizedWifiBroadcastDetailDto` (ver openapi.json)_
- `type` **(obrigatório)**: `string`
- `id` **(obrigatório)**: `string` (uuid)
- `name` **(obrigatório)**: `string`
- `metadata` **(obrigatório)**
...
- `securityConfiguration` **(obrigatório)**: `object`
  - _variantes por `type`: `OPEN`→`IntegrationWifiOpenSecurityConfigurationDetailDto`, `WPA2_PERSONAL`→`IntegrationWifiWpa2PersonalSecurityConfigurationDetailDto`, `WPA3_PERSONAL`→`IntegrationWifiWpa3PersonalSecurityConfigurationDetailDto`, `WPA2_WPA3_PERSONAL`→`IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationDetailDto`, `WPA2_ENTERPRISE`→`IntegrationWifiWpa2EnterpriseSecurityConfigurationDetailDto`, `WPA3_ENTERPRISE`→`IntegrationWifiWpa3EnterpriseSecurityConfigurationDetailDto`, `WPA2_WPA3_ENTERPRISE`→`IntegrationWifiWpa2Wpa3EnterpriseSecurityConfigurationDetailDto` (ver openapi.json)_
  - `type` **(obrigatório)**: `string`
  - `radiusConfiguration`
...
- _variantes por `type`: `STANDARD`→`IntegrationStandardWifiBroadcastCreateUpdateDto`, `IOT_OPTIMIZED`→`IntegrationIotOptimizedWifiBroadcastCreateUpdateDto` (ver openapi.json)_
- `type` **(obrigatório)**: `string`
- `name` **(obrigatório)**: `string`
- `network`
  - _variantes por `type`: `NATIVE`→`IntegrationWifiNativeNetworkDto`, `SPECIFIC`→`IntegrationWifiSpecificNetworkDto` (ver openapi.json)_
...
- `data` **(obrigatório)**: `array`
  - _array de_ `object`:
    - _variantes por `type`: `STANDARD`→`IntegrationStandardWifiBroadcastOverviewDto`, `IOT_OPTIMIZED`→`IntegrationIotOptimizedWifiBroadcastOverviewDto` (ver openapi.json)_
    - `type` **(obrigatório)**: `string`
    - `id` **(obrigatório)**: `string` (uuid)
    - `name` **(obrigatório)**: `string`
    - `enabled` **(obrigatório)**: `boolean`
    ...
    - `securityConfiguration` **(obrigatório)**
      - _variantes por `type`: `OPEN`→`IntegrationWifiOpenSecurityConfigurationOverviewDto`, `WPA2_PERSONAL`→`IntegrationWifiWpa2PersonalSecurityConfigurationOverviewDto`, `WPA3_PERSONAL`→`IntegrationWifiWpa3PersonalSecurityConfigurationOverviewDto`, `WPA2_WPA3_PERSONAL`→`IntegrationWifiWpa2Wpa3PersonalSecurityConfigurationOverviewDto`, `WPA2_ENTERPRISE`→`IntegrationWifiWpa2EnterpriseSecurityConfigurationOverviewDto`, `WPA3_ENTERPRISE`→`IntegrationWifiWpa3EnterpriseSecurityConfigurationOverviewDto`, `WPA2_WPA3_ENTERPRISE`→`IntegrationWifiWpa2Wpa3EnterpriseSecurityConfigurationOverviewDto` (ver openapi.json)_
      - `type` **(obrigatório)**: `string`
    - `broadcastingDeviceFilter`: Defines the custom scope of devices that will broadcast this WiFi network. If null, the WiFi network will be broadcast by all Access Point capable devices.
      - _variantes por `type`: `DEVICES`→`IntegrationWifiDevicesFilterDto`, `DEVICE_TAGS`→`IntegrationWifiDeviceTagsFilterDto` (ver openapi.json)_
      - `type` **(obrigatório)**: `string`
...
- `source` **(obrigatório)**: `object`
  ...
  - `trafficFilter`
    - _variantes por `type`: `PORT`→`IntegrationFirewallPolicySourcePortFilterDto`, `NETWORK`→`IntegrationFirewallPolicySourceNetworkFilterDto`, `MAC_ADDRESS`→`IntegrationFirewallPolicySourceMacAddressFilterDto`, `IP_ADDRESS`→`IntegrationFirewallPolicySourceIpAddressFilterDto`, `IPV6_IID`→`IntegrationFirewallPolicySourceIpv6IidFilterDto`, `REGION`→`IntegrationFirewallPolicySourceRegionFilterDto`, `VPN_SERVER`→`IntegrationFirewallPolicySourceVpnServerFilterDto`, `SITE_TO_SITE_VPN_TUNNEL`→`IntegrationFirewallPolicySourceSiteToSiteVpnTunnelFilterDto` (ver openapi.json)_
    - `type` **(obrigatório)**: `string`
- `destination` **(obrigatório)**: `object`
  ...
  - `trafficFilter`
    - _variantes por `type`: `PORT`→`IntegrationFirewallPolicyDestinationPortFilterDto`, `NETWORK`→`IntegrationFirewallPolicyDestinationNetworkFilterDto`, `IP_ADDRESS`→`IntegrationFirewallPolicyDestinationIpAddressFilterDto`, `IPV6_IID`→`IntegrationFirewallPolicyDestinationIpv6IidFilterDto`, `REGION`→`IntegrationFirewallPolicyDestinationRegionFilterDto`, `VPN_SERVER`→`IntegrationFirewallPolicyDestinationVpnServerFilterDto`, `SITE_TO_SITE_VPN_TUNNEL`→`IntegrationFirewallPolicyDestinationSiteToSiteVpnTunnelFilterDto`, `DOMAIN`→`IntegrationFirewallPolicyDestinationDomainFilterDto`, `APPLICATION`→`IntegrationFirewallPolicyDestinationApplicationFilterDto`, `APPLICATION_CATEGORY`→`IntegrationFirewallPolicyDestinationApplicationCategoryFilterDto` (ver openapi.json)_
    - `type` **(obrigatório)**: `string`
- `ipProtocolScope` **(obrigatório)**: Defines rules for matching by IP version and protocol.
  - _variantes por `ipVersion`: `IPV4`→`IntegrationFirewallPolicyIpv4ProtocolScopeDto`, `IPV6`→`IntegrationFirewallPolicyIpv6ProtocolScopeDto`, `IPV4_AND_IPV6`→`IntegrationFirewallPolicyIpv4AndIpv6ProtocolScopeDto` (ver openapi.json)_
...
- `schedule`: Defines date and time when the entity is active. If null, the entity is always active.
  - _variantes por `mode`: `EVERY_DAY`→`IntegrationFirewallScheduleEveryDayDto`, `EVERY_WEEK`→`IntegrationFirewallScheduleEveryWeekDto`, `ONE_TIME_ONLY`→`IntegrationFirewallScheduleOneTimeOnlyDto`, `CUSTOM`→`IntegrationFirewallScheduleCustomDto` (ver openapi.json)_
  - `mode` **(obrigatório)**: `string`
- `metadata` **(obrigatório)**
  - _variantes por `origin`: `USER_DEFINED`→`User defined entity metadata`, `SYSTEM_DEFINED`→`System defined entity metadata`, `DERIVED`→`Derived entity metadata` (ver openapi.json)_
  - `origin` **(obrigatório)**: `string`
...
- `data` **(obrigatório)**: `array`
  - _array de_ `object`:
    - _variantes por `type`: `LOCAL`→`IntegrationLocalLagGlobalDto`, `SWITCH_STACK`→`IntegrationSwitchStackLagGlobalDto`, `MULTI_CHASSIS`→`IntegrationMcLagGlobalDto` (ver openapi.json)_
    - `type` **(obrigatório)**: `string`
    - `id` **(obrigatório)**: `string` (uuid)
    - `members` **(obrigatório)**: `array`
      - _array de_ `object`:
...
- _variantes por `type`: `A_RECORD`→`IntegrationDnsARecordDto`, `AAAA_RECORD`→`IntegrationDnsAaaaRecordDto`, `CNAME_RECORD`→`IntegrationDnsCnameRecordDto`, `MX_RECORD`→`IntegrationDnsMxRecordDto`, `TXT_RECORD`→`IntegrationDnsTxtRecordDto`, `SRV_RECORD`→`IntegrationDnsSrvRecordDto`, `FORWARD_DOMAIN`→`IntegrationDnsForwardDomainPolicyDto` (ver openapi.json)_
- `type` **(obrigatório)**: `string`
- `id` **(obrigatório)**: `string` (uuid)
- `enabled` **(obrigatório)**: `boolean`
- `metadata` **(obrigatório)**
...
- _variantes por `type`: `A_RECORD`→`IntegrationDnsARecordCreateUpdateDto`, `AAAA_RECORD`→`IntegrationDnsAaaaRecordCreateUpdateDto`, `CNAME_RECORD`→`IntegrationDnsCnameRecordCreateUpdateDto`, `MX_RECORD`→`IntegrationDnsMxRecordCreateUpdateDto`, `TXT_RECORD`→`IntegrationDnsTxtRecordCreateUpdateDto`, `SRV_RECORD`→`IntegrationDnsSrvRecordCreateUpdateDto`, `FORWARD_DOMAIN`→`IntegrationDnsForwardDomainPolicyCreateUpdateDto` (ver openapi.json)_
- `type` **(obrigatório)**: `string`
- `enabled` **(obrigatório)**: `boolean`
...
- _variantes por `type`: `PORTS`→`IntegrationPortTrafficMatchingListDto`, `IPV4_ADDRESSES`→`IntegrationIpV4TrafficMatchingListDto`, `IPV6_ADDRESSES`→`IntegrationIpV6TrafficMatchingListDto` (ver openapi.json)_
- `type` **(obrigatório)**: `string`
- `id` **(obrigatório)**: `string` (uuid) ex: `ffcdb32c-6278-4364-8947-df4f77118df8`
...
- _variantes por `type`: `PORTS`→`IntegrationPortTrafficMatchingListCreateUpdateDto`, `IPV4_ADDRESSES`→`IntegrationIpV4TrafficMatchingListCreateUpdateDto`, `IPV6_ADDRESSES`→`IntegrationIpV6TrafficMatchingListCreateUpdateDto` (ver openapi.json)_
- `type` **(obrigatório)**: `string`
- `name` **(obrigatório)**: `string` ex: `Allowed port list|Protected IP list`
...
- `data` **(obrigatório)**: `array`
  - _array de_ `object`:
    - _variantes por `type`: `OPENVPN`→`IntegrationSiteToSiteOpenVpnTunnelOverviewDto`, `IPSEC`→`IntegrationSiteToSiteIpsecTunnelOverviewDto`, `WIREGUARD`→`IntegrationSiteToSiteWireguardTunnelOverviewDto` (ver openapi.json)_
    - `type` **(obrigatório)**: `string`
    - `id` **(obrigatório)**: `string` (uuid)
    - `name` **(obrigatório)**: `string`
    - `metadata` **(obrigatório)**
...
- `data` **(obrigatório)**: `array`
  - _array de_ `object`:
    - _variantes por `type`: `OPENVPN`→`IntegrationOpenVpnServerOverviewDto`, `WIREGUARD`→`IntegrationWireguardServerOverviewDto`, `L2TP`→`IntegrationL2tpServerOverviewDto`, `PPTP`→`IntegrationPptpServerOverviewDto`, `UID`→`IntegrationUidVpnServerOverviewDto` (ver openapi.json)_
    - `type` **(obrigatório)**: `string`
    - `id` **(obrigatório)**: `string` (uuid)
    - `name` **(obrigatório)**: `string`
    - `enabled` **(obrigatório)**: `boolean`
