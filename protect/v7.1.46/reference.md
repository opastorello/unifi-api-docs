# UniFi Protect API - v7.1.46 - Referência

> Espelho automático de [`developer.ui.com/protect/v7.1.46`](https://developer.ui.com/protect/v7.1.46).
> OpenAPI `3.1.0` · 73 operações em 54 paths · atualizado na origem em `2026-06-02T09:19:13.019Z`.
