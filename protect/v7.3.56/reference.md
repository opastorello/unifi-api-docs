# UniFi Protect API - v7.3.56 - Referência

> Espelho automático de [`developer.ui.com/protect/v7.3.56`](https://developer.ui.com/protect/v7.3.56).
> OpenAPI `3.1.0` · 74 operações em 55 paths · atualizado na origem em `2026-09-24T14:04:57.178Z`.
